...
module_dir = os.path.join(__location__, "../src/hatchit")
try:
...
html_theme_options = {
    ...
    "source_repository": "https://github.com/YOUR_ORG_OR_USERNAME/hatchit",
    "source_branch": "main",
...
latex_documents = [
    ("index", "user_guide.tex", "hatchit Documentation", "Jayaram Kancherla", "manual")
]
